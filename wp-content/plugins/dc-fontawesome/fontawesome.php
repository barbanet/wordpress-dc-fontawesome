...
function getDcFontAwesomeStyles()
{
    ...
    switch($_settings_mode) {
        case 'local':
            wp_enqueue_style('font-awesome', plugin_dir_url(__FILE__) . 'css/fontawesome-all.min.css', false, getDcFontawesomeVersion());
            break;
        case 'remote':
            wp_enqueue_style('font-awesome', '//use.fontawesome.com/releases/v5.0.6/css/all.css', false, getDcFontawesomeVersion());
            break;
    }
}
